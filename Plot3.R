### This is the code for creating plot 3. Steps 1-3 are setting up the data, Step 4 plots.
...
##Step 4: create the plot as a png (initial plot for sub_1 and then adding 2 lines over the top for sub_2 and sub_3)
