### This is the code for creating plot 2. Steps 1-3 are setting up the data, Step 4 plots.
...
##Step 4: create the plot as a png
png("plot2.png",width=480,height=480)
with(power_select, plot(Global_active_power~datetime, type="l",ylab="Global Active Power (kilowatts)", xlab="") )
dev.off()
